...
table <- reactable(
  ...
  columnGroups = list(
    colGroup(name = "BOX SCORE RAPTOR", columns = box_score_raptor),
    colGroup(name = "ON/OFF RAPTOR", columns = on_off_raptor),
    colGroup(name = "OVERALL RAPTOR", columns = overall_raptor)
  ),
  rownames = TRUE
)
table
